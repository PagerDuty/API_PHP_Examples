...
$session = curl_init();
$URL = 'https://' . urlencode($SUBDOMAIN) . '.pagerduty.com/api/v1/escalation_policies/' . urlencode($ESCALATION_POLICY_ID) . '/escalation_rules/' . urlencode($ESCALATION_RULE_ID);
$session = curl_init();

$json_payload = array(
  "escalation_delay_in_minutes" => 77,
  "targets" => array(
      array(
          "type" => "user",
          "id" => "PJR28TQ"
